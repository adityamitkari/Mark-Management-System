    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">Student Mark System</a>
            </div>
            <!-- /.navbar-header -->
		...
		<!-- feedback-->
		<li>
         <a href="#"><i class="fa fa-user fa-book"></i>Mark<span class="fa arrow"></span></a>
           <ul class="nav nav-second-level">
                             
<li><a href="dashboard.php?info=feedback"><i class="fa fa-eye"></i> MARK</a></li>
<li><a href="dashboard.php?info=feedback_average"><i class="fa fa-eye"></i> MARK AVERAGE</a></li>
