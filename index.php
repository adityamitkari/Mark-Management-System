    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#66CCFF">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#00000">MARK </a>
...
<!-- slider -->			
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
                ...
                <h2><b>M.S. Bidve Engineering College , Latur</b></h2>
				
                
                <b>In pursuance with Mahatma Basweshwar’s dream, Mahatma Basweshwar Education Society has been established in 1963 at Latur. This Society is one of the oldest & reputed educational societies in Marathwada region. In the era of globalization, to create engineering graduates having knowledge with global insight, meeting the needs of industry, M.B. Education Society started M. S. Bidve Engineering College in 1983 at Latur, affiliated to Swami Ramanand Teerth Marathwada University, Nanded and approved by AICTE, New Delhi. Recently the institute has been awarded ISO-9001:2000 certificate.</b>
			</div>	
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#000000">Designed By Uttareshwar Mitkari  for M.S.Bidve Engineering college </span>
	</div>
    <!-- jQuery -->
