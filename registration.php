...
$query="insert into user values('','$n','$e','$pass','$mob','$pro','$sem','$gen','$imageName','$dob','$PRN_NO',now())";
...
?>
	...
	<caption><h2 align="center">Registration Form</h2><a style="color:#0000FF"> </a></caption>
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<option>Electronics and Telicommunication</option>
