...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Barshi Rd, Pakharsangvi, Latur<br>Latur, Maharastra, India<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 777*****86</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:uttareshwarmitkari29@gmail.com">uttareshwarmitkari29@gmail.com</a>
                </p>
